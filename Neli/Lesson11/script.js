...
recipes.forEach(el => {
    ...
    const ingredientsContainerElem = document.createElement('ul');

 el.ingredients.forEach(el => {
    const ingredient = document.createElement('li');
    ingredient.innerText = el;
    ingredientsContainerElem.append(ingredient)
 }

 )

    nameElem.innerText = el.name;
    ingredientsElem.innerText = 'Ingredients:'

    imgElem.setAttribute('src', el.image);
    imgElem.setAttribute('alt', el.name);

    cardElem.append(imgElem, nameElem, ingredientsElem, 
        ingredientsContainerElem);
    recipesContainer.append(cardElem);
});
